...
export const metadata: Metadata = {
  title: "Contacto — Heredia",
  description: "Contacta con el equipo de Heredia. Soporte tecnico, ventas y consultas generales.",
  alternates: { canonical: "https://heredia.app/contacto" },
};

const contacts = [
  {
    title: "Soporte tecnico",
    email: "soporte@heredia.app",
